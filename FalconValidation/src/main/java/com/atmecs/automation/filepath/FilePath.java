...
public class FilePath {
	...
	public static final String Location_Reader = "./src/main/java/com/atmecs/automation/LocationReader/LocationReader.java";
	public static final String Config_Path = "./src/test/resources/config.properties"; 
	public static final String locator_path = "./src/test/resources/Locators/Validation.properties";
	public static final String User_data = "./src/main/resources/userdata/userdata.properties";
